...
const ResetPasswordSchema = Yup.object().shape({
  password: Yup.string().min(8, 'Password must be at least 8 chars').required('New password is required'),
          ...
          <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-2xl p-6 md:p-8 shadow-2xl shadow-black/[0.03]">
            <div className="flex flex-col items-center mb-8">
              ...
              <div className="text-center">
                <h1 className="text-smart-dark dark:text-white text-xl font-bold tracking-tight mb-2">Set New Password</h1>
