    ...
    <div className="min-h-screen flex flex-col bg-background-light dark:bg-[#131f1a]">
      <header className="flex items-center justify-between px-6 py-3 md:px-12 bg-white/80 dark:bg-zinc-900/50 backdrop-blur-sm border-b border-gray-100 dark:border-white/5">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/register" className="bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-lg hover:brightness-95 transition-all">
            Get Started
          </Link>
        </div>
      </header>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-2xl p-6 md:p-8 shadow-2xl shadow-black/[0.03]">
            <div className="flex flex-col items-center mb-6">
              ...
              <div className="text-center">
                <h1 className="text-smart-dark dark:text-white text-xl font-bold tracking-tight mb-0.5">Welcome Back</h1>
                <p className="text-slate-gray/60 dark:text-gray-400 text-[12px]">Sign in to your account</p>
              </div>
            </div>
            ...
            >
              <Form className="space-y-5">
                ...
                <AuthInput
                  ...
                  icon="lock"
                  rightElement={
                    <Link to="/forgot-password" title="Forgot password?" className="text-primary text-[11px] font-bold hover:underline cursor-pointer">Forgot password?</Link>
                  }
                />
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-[9px] uppercase">
                <span className="bg-white dark:bg-zinc-900 px-4 text-gray-400 font-bold tracking-widest">Or continue with</span>
              </div>
            </div>

            <button className="flex items-center justify-center gap-3 w-full border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 py-2.5 rounded-xl transition-all font-bold text-slate-gray dark:text-white text-xs">
